  ...
  return (
    <>
      ...
      >
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-6 items-center text-lg">
            ...
            {/* Location */}
            <Link to="#" onClick={handleLocate} className="relative cursor-pointer group">
              <MapPin
                className="w-7 h-7 text-[#28ffd4] hover:scale-110 transition-transform"
                strokeWidth={1}
              />
              ...
              <div className="flex items-center gap-3">
                {isAdmin && (
                  <MotionDiv whileHover={{ scale: 1.05 }} transition={{ duration: 0.2 }}>
                    <Link
                      to="/admin/products"
                      className="px-3 py-2 rounded-lg bg-yellow-500 text-black hover:bg-yellow-400 font-semibold"
                    >
                      Dashboard
                    </Link>
                  </MotionDiv>
          ...
          <div className="md:hidden flex items-center space-x-4">
            ...
            {!isAuthenticated ? (
              ...
              <>
                ...
                <button
                  onClick={handleLogout}
                  className="px-3 py-1 rounded-md bg-red-600 hover:bg-red-500 text-white text-sm font-semibold"
                >
                  Logout
                </button>
              </>
      ...
      {mobileOpen && (
        ...
        >
          <div className="px-6 py-6 flex flex-col items-center gap-5 text-lg font-medium">
            <NavLink to="/" onClick={() => setMobileOpen(false)} className={getActiveClass}>
              Home
            </NavLink>
            <NavLink to="/about" onClick={() => setMobileOpen(false)} className={getActiveClass}>
              About
            </NavLink>
            <NavLink to="/services" onClick={() => setMobileOpen(false)} className={getActiveClass}>
              Services
            </NavLink>
            <NavLink to="/contact" onClick={() => setMobileOpen(false)} className={getActiveClass}>
              Contact
            </NavLink>
          </div>
        </MotionDiv>
